...
describe Buckaroo::Ideal::RefundInfoRequest do
  let(:order)   { Buckaroo::Ideal::Order.new          }
  let(:request) { Buckaroo::Ideal::RefundInfoRequest.new(order) }
  ...
  it 'modifies the process url to reflect the transaction type' do
    wanted_url = 'https://testcheckout.buckaroo.nl/nvp/?op=RefundInfo'
