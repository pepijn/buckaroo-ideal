...
Gem::Specification.new do |gem|
  gem.authors       = ["Tom-Eric Gerritsen", "Thomas van der Pol"]
  gem.email         = ["tomeric@eet.nu", "thomasp@everydayhero.com.au"]
  ...
  gem.homepage      = "http://github.com/tvanderpol/buckaroo-ideal"
